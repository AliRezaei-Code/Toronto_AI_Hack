...
import { particleEventName } from '@/lib/particle-events'
...
export function ParticleBurstLayer() {
  ...
  const handleBurst = useCallback(
    (event: CustomEvent<{ clientX: number; clientY: number; color?: string; intensity?: number }>) => {
      ...
      const position = camera.position.clone().add(direction.multiplyScalar(6.5))
